 ...
 */
@DisplayName("Normal Question Test")
public class Test_01 {
    private final String startingTitle = "Kategorie:Fiktivní_postavy_podle_povolání";
    private final String categoriesDirectory = "test_01/categories";
    private final String questionsDirectory = "test_01/questions";
